...
- (id)init {
	if (self = [super initWithFrame:CGRectZero]) {
        ...
        _closeButton=[UIMakerUtil createImageButton:@"取消" point:CGPointZero];
		//_closeButton = [[UIButton buttonWithType:UIButtonTypeCustom] retain];
		//[_closeButton setImage:closeImage forState:UIControlStateNormal];
		//[_closeButton setBackgroundImage:backImage forState:UIControlStateNormal];
		//[_closeButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
		//[_closeButton setTitleColor:ORANGE_BG forState:UIControlStateHighlighted];
        _closeButton.tintColor=ORANGE_BG;
        _closeButton.backgroundColor=ORANGE_BG;
		...
		_titleLabel.text = @"授权";
		_titleLabel.backgroundColor = ORANGE_BG;
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request
 navigationType:(UIWebViewNavigationType)navigationType {
	...
	pasteboard.string=[_webView stringByEvaluatingJavaScriptFromString:@"document.getElementById('u').value"];
    //CFShow([_webView stringByEvaluatingJavaScriptFromString:@"document.getElementById('p').value"]);
...
- (void)show {
	...
	_titleLabel.frame = CGRectMake(
								   ...
								   kBorderWidth,
								   innerWidth,
								   _titleLabel.frame.size.height + kTitleMarginY*2+4+14);
	...
	_closeButton.frame = CGRectMake(
									...
									_titleLabel.frame.size.height-10);
