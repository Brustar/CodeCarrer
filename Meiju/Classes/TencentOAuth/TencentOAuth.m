...
- (void)authorize:(NSArray *)permissions inSafari:(BOOL)bInSafari {
	[self authorize:permissions localAppId:nil inSafari:bInSafari];
}


- (void)authorize:(NSArray *)permissions localAppId:(NSString *)localAppId inSafari:(BOOL)bInSafari{
...
- (void)deleteAPIRequestBySeq:(NSString*)seq
{
	...
	//if (apiRequest)[apiRequest release];
