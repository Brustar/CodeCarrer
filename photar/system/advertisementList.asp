...
function goPage(page){
	document.Pageform.action="AdvertisementList.asp?thispage="+page;
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td bgcolor="#0C89A7"  valign="middle" >
            <p class="unnamed1" align="center"><strong>图 片 专 区 管 理</strong> </td>
        </tr>
      </table>
    </td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <form name="FrmNews" method="post">
    ...
    <tr>
                              <td class="cpx12black" height=65>&nbsp;图片名： 
      ...
      <input type=hidden name=byMode value="">
        ...
        <input type="text" name=ENDDATE value="<%=endDate%>" onClick="PopDate(this);"size=10 class="text1" readonly></input>
                ...
                <a href="AdvertisementinfoEdit.asp?Mode=NewInfo&rightsID=<%=rightsID%>&CompanyID=<%=companyid%>" class="cpx12black"><img src="../images/button_add.gif" border="0" alt="新增" align="absmiddle"></a>&nbsp;&nbsp;
<table border="0" cellspacing="8" cellpadding="0" width="100%">
                  <tr>
                    <td width="100%" bgcolor="#646464" colspan="2">
                      <table border="0" width="100%" cellpadding="3" cellspacing="1">
                    <tr bgcolor="#C8C8C8" align=center> 
                      <td width="143" class="cpx12black">图片名</td>
                      <td class="cpx12black">图片链接地址</td>
                      <td class="cpx12black">所属栏目</td>
		...
		if thispage>rs.PageCount then thispage=rs.PageCount
   		for i=1 to rs.pagesize  
			...
			elseif cateid=2 then
				catename="活动图片"
			elseif cateid=3 then
				catename="专卖店"
			elseif cateid=4 then
				catename="重要新闻"
			elseif cateid=5 then
				catename="新闻活动图片"
			else
				catename="广告欣赏轮播"
			end if
...
%>
                    <tr bgcolor="#FFFFFF" align=left> 
                      <td width="143"> <div align="center"><a href="AdvertisementinfoEdit.asp?Mode=EditInfo&ID=<%=ID%>&rightsID=<%=rightsID%>&CompanyID=<%=companyid%>" class="cpx12black"> 
                          <%=SiteName1%></a> </div></td>
                      <td class="cpx12black"> <div align="center"><%=URL%></div></td>
                      <td align="center" class="cpx12black"><%=catename%></td>
                      <td width="91" class="cpx12black"><div align="center"><a href="../uploadfiles/<%=LogoURL%>" title="显示该图片" target="_blank" class="cpx12black"><%=LogoURL%></a></div></td>
