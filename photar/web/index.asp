  ...
  <tr>
    <td width="190" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td><div align="center"><a href="reporter.asp"><img src=<%=Timg("images/index_left1.gif")%> width="177" height="53" border="0"></a></div></td>
        </tr>
        <tr> 
          <td><div align="center"><a href="user.asp"><img src=<%=Timg("images/index_left3.gif")%> width="177" height="53" border="0"></a></div></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><div align="center"><font color="F78E00" class="font14">&nbsp;&nbsp;<br><br>
<br>
              访问丰达集团成员网站</font>
            ...
            <div align="center">
              <select name="goto" onChange="jumpMenu('this',this)" style="width:175">
                <option value="">请选择集团成员网站</option>
				<% 
		  sql="select SiteName,URL from friendsiteinfo where ischeck=1 and english=0"
                          ...
                          <tr> 
                            <td height="25" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="95%" height="30"><font color="F78E00" class="font14">重要新闻</font></td>
                                </tr>
                              </table>
...
setInterval("rotateimage()",pause)
                                  ...
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="6">
                                      <tr> 
                                        <td bgcolor="#FFFFFF"><font color="#666666" class="fonthr-18"><a href="news_show.asp?id=<%= getdata("id","Newsinfo","cateid","3") %>" class="a1" target="_blank" title="<%= getdata("subject","Newsinfo","cateid","3") %>"><%= upstring(gettextdata("content","Newsinfo","cateid","3"),150) %></a></font>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td><div align="right"><font color="#999999"><strong><a href="news_show.asp?id=<%= getdata("id","Newsinfo","cateid","3") %>" class="a1" target="_blank" title="<%= getdata("subject","Newsinfo","cateid","3") %>"><font color="#999999">更多...</font></a></strong></font></div></td>
                                            </tr>
                                          </table></td>
                                      </tr>
                                    </table></td>
              ...
              <tr> 
                <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="95%" height="30"><font color="F78E00" class="font14">新闻动态</font></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
...
<% 
sql="select top 5 * from Newsinfo where isCheck=1 and english=0 and cateid=1 order by modified desc"
set rs=conn.execute(sql) 
for i=0 to 4
 %>		
<% 
...
%>
              <tr> 
                <td width="381" height="30">&nbsp;&nbsp;<img src="images/biao5.gif" width="3" height="5">&nbsp;<a href="news_show.asp?id=<%= rs("id") %>" class="a1" target="_blank" title="<%= rs("subject") %>"><%= upstring(rs("subject"),28) %></a> <font color="#666666" class="fonthr-18"><!-- (<%= left(rs("modified"),instr(rs("modified")," ")-1) %>) --></font></td>
                <td width="75"><strong><a href="news.asp" target="_blank"><font color="#999999">更多...</font></a></strong></td>
              </tr>
              <tr> 
...
<%else%>
              <tr> 
                <td height="30" colspan="2">&nbsp;&nbsp;<img src="images/biao5.gif" width="3" height="5">&nbsp;<a href="news_show.asp?id=<%= rs("id") %>" class="a1" target="_blank" title="<%= rs("subject") %>"><%= upstring(rs("subject"),28) %></a> <font color="#666666" class="fonthr-18"><!-- (<%= left(rs("modified"),instr(rs("modified")," ")-1) %>) --></font></td>
              </tr>
              <tr> 
                <td height="1" colspan="2" bgcolor="EFEBEF"><img src="images/blank.gif" width="1" height="1"></td>
              </tr>
...
%>					
          ...
          <td width="242" valign="top"> <table width="225" border="0" align="center" cellpadding="3" cellspacing="0">
              <tr> 
                <td height="30"><strong><font color="00A6BD">活动图片</font> <font color="00AE9C">&gt;&gt;</font></strong></td>
              </tr>
              <tr> 
                <td width="225">
				<div align="center"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center">
              <p align="left"><img src=<%=Timg("images/example4_1.gif")%> width="471" height="103" hspace="10" vspace="0" border="0" usemap="#Map2"></p>
            </div></td>
        </tr>
      </table>
      <br>
...
<map name="Map2">
  ...
  <area shape="rect" coords="391,5,469,102" href="server.asp">
</map>
</body>
</html>
