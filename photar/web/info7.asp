  ...
  <tr> 
    <td width="168" valign="top"> <table width="166" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="166" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="29" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
    ...
    <td width="836" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="740" background="images/d_tiao.gif">　<a href="index.asp">首页</a> 
            &gt; <a href="info.asp">关于丰达</a> &gt; <a href="info7.asp" class="a1">营<q>销网络</a></td>
      ...
      <table width="100%" height="400" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="616" valign="top"><br> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                ...
                <td width="200" height="400" valign="top" background="images/info7_d.jpg"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="9">&nbsp;</td>
                    </tr>
                  ...
                  <div align="center">
                    <marquee direction="up" scrollamount=1 scrolldelay=30 trueSpeed border="0" width="140" height="400" id='helpor_net' onmouseover='helpor_net.stop()' onmouseout='helpor_net.start()'>
                    <% 
         sql="select * from advertisement where ischeck=1 and english=0 and cateid=3 order by modified"
         set rs=conn.execute(sql)
         while not rs.eof
       %>
                    <a href="sell2_show.asp?id=<%= rs("id") %>"><img src="../uploadfiles/<%= rs("LogoURL") %>" width=140 height=98 hspace="1" vspace="1" border="0" alt="<%= rs("SiteName") %>"></a><br>
                    <br>
                    <% 
         rs.movenext
         wend
        ...
        %>
            ...
            <table width="80%" border="0" cellpadding="25" cellspacing="0">
              <tr> 
                <td><font color="#666666"><%= UnParseString(gettextdata("salenet","siteinit","1","1")) %></font></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
