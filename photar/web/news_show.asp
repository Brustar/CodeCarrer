    ...
    <td> <table width="778" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="1004" height="200">
              ...
              <embed src="flash/news.swf" width="1004" height="200" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" menu="false" wmode="transparent"></embed></object></td>
        </tr>
      </table></td>
  </tr>
</table>
  ...
  <tr> 
    <td width="168" valign="top"> <table width="166" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="166" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="29" background="images/lan_di.gif"><a href="mien.asp" class="a7"><strong><img src="images/biao7.gif" width="13" height="13" hspace="10" border="0"></strong></a><a href="news.asp" class="a7"><strong>丰达新闻</strong></a></td>
        </tr>
        <tr> 
          <td height="2"><img src="images/blank.gif" width="1" height="1"></td>
        </tr>
        <tr> 
          <td height="25" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td height="18" valign="bottom"><img src="images/biao5.gif" width="3" height="5" hspace="5"><font color="393939"><a href="news.asp" class="a6">企业新闻</a></font></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><font color="393939"><a href="news.asp?cateid=2" class="a6">产品新闻</a></font></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
    ...
    <td width="836" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="740" background="images/d_tiao.gif">　<a href="index.asp">首页</a> 
            &gt; <a href="news.asp">丰达新闻</a> &gt; <a href="news.asp" class="a1">企业新闻</a></td>
        ...
        <tr> 
          ...
          <td valign="top"><br>
            <table width="95%" border="0" align="center" cellpadding="10" cellspacing="0">
              <tr> 
                <td height="20" valign="bottom" bgcolor="#00556B"> <div align="center"><font color="#FFFFFF" class="font14"><strong><%= getdata("subject","newsinfo","id",request("id")) %></strong></font></div></td>
              </tr>
              <tr> 
                <td height="25"> 
              ...
              <tr> 
                <td class="fonthr-18">                  
                  <p><font color="#666666">&nbsp;&nbsp;&nbsp;&nbsp;<%= UnParseString(getTextData("content","newsinfo","id",request("id"))) %></font></p>
				   <% if img<>"$" then %>
                  <div align="center"><img src="../uploadfiles/<%= img %>"></div> 
                  <% End If %>
				  </td>
              </tr>
            </table></td>
