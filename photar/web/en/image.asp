      ...
      <table width="196" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td bgcolor="F0EBF1"><table width="170" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="25"><strong>Item Link</strong></td>
              </tr>
              <tr>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="573" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="E7E7E7">
              ...
              <tr> 
                <td height="30" colspan="3" bgcolor="E7E7E7">&nbsp;&nbsp;<strong>Image 
                  Area：</strong></td>
              </tr>
<% 
thispage=1
if request("thispage")<>empty then thispage = Cint(request("thispage"))
sql="select * from advertisement where ischeck=1 and english=1 and cateid=2 order by modified"
...
<p align="right"><% If thispage>1 Then %> <a href="javascript:goPage(1)" class="a1">First</a> 
        <a href="javascript:goPage(<%= thispage-1 %>)" class="a1">Previous</a> 
        <% Else %>
        First Previous 
        <% End If %> <% If thispage<rs.pagecount Then %> <a href="javascript:goPage(<%= thispage+1 %>)" class="a1">Next</a> 
        <a href="javascript:goPage(<%= rs.pagecount %>)" class="a1">End</a> 
        <% Else %>
        Next End 
        <% End If %></p></form></td>
              </tr>
