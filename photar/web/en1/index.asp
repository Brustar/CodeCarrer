...
<table width="930" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="190" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><font color="F78E00" class="font14">Visit Members Site Of Photar 
            Group</font><br>
            <br><div align="center">
              <select name="goto" onChange="jumpMenu('this',this)">
                <% 
...
setInterval("rotateimage()",pause)
                                  ...
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="6">
                                      <tr> 
                                        <td bgcolor="#FFFFFF"><font color="#666666" class="fonthr-18"><a href="news_show.asp?id=<%= getdata("id","Newsinfo","cateid","3") %>" class="a1" target="_blank" title="<%= getdata("subject","Newsinfo","cateid","3") %>"><%= upstring(gettextdata("content","Newsinfo","cateid","12"),150) %></a></font>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td><div align="right"><font color="#999999"><strong><a href="news_show.asp?id=<%= getdata("id","Newsinfo","cateid","3") %>" class="a1" target="_blank" title="<%= getdata("subject","Newsinfo","cateid","3") %>"><font color="#999999">More...</font></a></strong></font></div></td>
                                            </tr>
                                          </table></td>
                                      </tr>
                                    </table></td>
...
%>
              <tr> 
                <td width="381" height="30">&nbsp;&nbsp;<img src="images/biao5.gif" width="3" height="5">&nbsp;<a href="news_show.asp?id=<%= rs("id") %>" class="a1" target="_blank" title="<%= rs("subject") %>"><%= upstring(rs("subject"),18) %></a> <font color="#666666" class="fonthr-18"><!-- (<%= left(rs("modified"),instr(rs("modified")," ")-1) %>) --></font></td>
...
<%else%>
              <tr> 
                <td height="30" colspan="2">&nbsp;&nbsp;<img src="images/biao5.gif" width="3" height="5">&nbsp;<a href="news_show.asp?id=<%= rs("id") %>" class="a1" target="_blank" title="<%= rs("subject") %>"><%= upstring(rs("subject"),18) %></a> <font color="#666666" class="fonthr-18"><!-- (<%= left(rs("modified"),instr(rs("modified")," ")-1) %>) --></font></td>
              </tr>
              <tr> 
                <td height="1" colspan="2" bgcolor="EFEBEF"><img src="images/blank.gif" width="1" height="1"></td>
              </tr>
