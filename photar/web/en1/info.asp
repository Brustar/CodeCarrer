...
<!--#include file="top.asp"-->
	 ...
	 select case field
		...
		case "about"
			leftprompt="Introduction"
		case "manufacture"
			leftprompt="Photar Industrial Park"
		case "Culture"
			leftprompt="Culture"
		case "technology"
			leftprompt="Advanced Technology"
		case "SiteMap"
			leftprompt="Site Map"
		case "management"
			leftprompt="规模经营"
		...
		case "promotion"
			leftprompt="Marketing activity"
		case "sale"
			leftprompt="Marketing network"
			response.Redirect("info7.asp")
		case "market"
			leftprompt="上市公司形象"
		case "tactic"
			leftprompt="Brand strategy"
		case "CEOsign"
			leftprompt="Management Team"
	 end select 
	   %>
...
<table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td height="29" background="images/lan_di.gif"><img src="images/biao7.gif" width="13" height="13" hspace="10"><a href="info.asp" class="a7"><strong>About Photar</strong></a></td>
        </tr>
        <tr> 
          <td height="29" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td height="18" valign="bottom"><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=about" class="a6">Introduction</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=CEOsign" class="a6">Management Team</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=manufacture" class="a6">Industrial Park</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=technology" class="a6">Advanced Technology</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=Culture" class="a6">Culture</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=sale" class="a6">Marketing network</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"><table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="info.asp?field=tactic" class="a6">Brand strategy</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
    ...
    <td width="836" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="740" background="images/d_tiao.gif">　<a href="index.asp" class="a1">Index</a> 
            <font color="0071BD">&gt;</font> <a href="info.asp" class="a1">About 
            Photar </a> <font color="0071BD">&gt;</font> <a href="info.asp?Field=<%= field %>"><%= leftprompt %></a></td>
