    ...
    <td width="164" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#F7F7F7" onMouseOver="bgColor = '#F6FFED'" onMouseOut="bgColor = '#F7F7F7'"> 
                ...
                <td><a href="sell.asp?field=sale">营<q>销活动</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#F7F7F7" onMouseOver="bgColor = '#F6FFED'" onMouseOut="bgColor = '#F7F7F7'"> 
                <td width="35"><img src=<%=Timg("images/biao1.gif")%> width="35" height="22"></td>
                <td><a href="producthandbook.asp">产品推广</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#F7F7F7" onMouseOver="bgColor = '#F6FFED'" onMouseOut="bgColor = '#F7F7F7'"> 
                <td width="35"><img src=<%=Timg("images/biao1.gif")%> width="35" height="22"></td>
                <td><a href="sell.asp?field=build">品牌建设</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#F7F7F7" onMouseOver="bgColor = '#F6FFED'" onMouseOut="bgColor = '#F7F7F7'"> 
                <td width="35"><img src=<%=Timg("images/biao1.gif")%> width="35" height="22"></td>
                <td><a href="sell.asp?field=salebook">促销手册</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#F7F7F7" onMouseOver="bgColor = '#F6FFED'" onMouseOut="bgColor = '#F7F7F7'"> 
                <td width="35"><img src=<%=Timg("images/biao1.gif")%> width="35" height="22"></td>
                <td> <a href="sell.asp?field=bbs">营<q>销论坛</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
    ...
    <td width="613" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="36" background="images/d_tiao.gif">　　<a href="index.asp" class="a1">首页</a> 
            ...
            <font color="0071BD">&gt;</font> 产品推广</td>
        </tr>
      </table>
      <br>
	...
	if not rs.eof then
		...
		if thispage>rs.PageCount then thispage=rs.PageCount
   		for i=1 to rs.pagesize  
			...
			pictrue=left(pictrue,instr(pictrue,"$")-1)
			URL=rs("URL")
