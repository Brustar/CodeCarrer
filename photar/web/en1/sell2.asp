        ...
        <tr> 
          ...
          <td valign="top"><br> 
            <table width="90%" border="0" cellpadding="8" cellspacing="0">
              <tr> 
                <td valign="top"> <table width="599" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td><img src=<%=Timg("images/info_top.gif")%> width="599" height="8"></td>
                    </tr>
                    <tr> 
                      <td valign="top" background="images/info_d.gif"> <div align="center"> 
                          <p>&nbsp;</p>
                          <table width="550" height="120" border="0" cellpadding="0" cellspacing="0">
                            <% 
thispage=1
if request("thispage")<>empty then thispage = Cint(request("thispage"))
sql="select * from advertisement where ischeck=1 and english=0 and cateid=1 order by modified desc"
...
rs.open sql,conn,1,3
 ...
 %>
                          ...
                          <table width="550" height="120" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td colspan="3"><form name="Pageform" method="post">
                                  <p align="right">
                                    <% If thispage>1 Then %>
