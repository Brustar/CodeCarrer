...
<table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td height="29" background="images/lan_di.gif"><a href="mien.asp" class="a7"><strong><img src="images/biao7.gif" width="13" height="13" hspace="10" border="0">丰达风采</strong></a></td>
        </tr>
        <tr> 
          <td height="2"><img src="images/blank.gif" width="1" height="1"></td>
        </tr>
        <tr> 
          <td height="25" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td height="18" valign="bottom"><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="mien.asp?field=honor" class="a6">载誉丰达</a></td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><a href="mien.asp?field=visualize" class="a6">形象展示</a></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><font color="393939"><a href="mien.asp?field=publicAct" class="a6">公益活动</a></font></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" onMouseOver="bgColor = '#E7FAFF'" onMouseOut="bgColor = '#ffffff'"> 
            <table width="135" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><img src="images/biao5.gif" width="3" height="5" hspace="5"><font color="393939"><a href="mien.asp?field=JobStratagem" class="a6">丰达之歌</a></font></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
    ...
    <td width="836" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="740" background="images/d_tiao.gif">　<a href="index.asp">首页</a> 
            &gt; <a href="mien.asp">丰达风采</a> &gt; <a href="mien1.asp"></a><a href="mien.asp?Field=<%= field %>" class="a1"><%= leftprompt %></a></td>
        ...
        <tr> 
          ...
          <td valign="top"><br>
            <table width="95%" border="0" align="center" cellpadding="8" cellspacing="0">
              <tr> 
                <td> <p class="fonthr-18"><font color="#666666"><%= UnParseString(gettextdata(field,"siteinit","1","1")) %></font> 
                  </p>
