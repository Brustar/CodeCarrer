...
function AppBase:ctor(configs)
    self.configs_ = {
        viewsRoot  = {"app.views","app.Warrior","app.Maze","app.Login","app.CoinRecord",
        "app.FoundWord","app.FiveChess","app.CrazyCat","app.SuperDye","app.FlyMore",
        "app.BrushThrough","app.ChineseBlock","app.Bubble","app.FlyMore.views","app.GiftRecord",
        "app.BigWord"},
